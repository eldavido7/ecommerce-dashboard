...
import { BarChart3, Gift, Home, Package, Settings, ShoppingCart, Tag, X } from "lucide-react"
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      {/* Mobile overlay */}
      {isOpen && <div className="fixed inset-0 z-40 bg-background/80 md:hidden" onClick={onClose} />}
